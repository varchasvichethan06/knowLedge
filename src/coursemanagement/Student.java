...
public class Student extends Account{
    ...
    public void enroll(){
        ...
        try {
             ...
             */
            if(co.isInDatabase(courseID)) {
                Module mo1 = new Module();
                if (mo1.checkModulesInDataBase(courseID)) {
                     ...
                     */
                        if (level == 6) {
                             ...
                             */
                                ...
                                for (String six : levelSix) {//check if iterator has the elements
                                    System.out.println(six);//printing the element and move to next
                                }
                                System.out.println("----------------------------------");
