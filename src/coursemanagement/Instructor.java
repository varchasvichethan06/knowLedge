...
public class Instructor extends Account{
    ...
    public void displayModules() {
        ...
        for (String cours : courses) {//check if iterator has the elements
            System.out.println(cours);//printing the element and move to next
        }
    }
    ...
    public void displayInstructors(int id){
        ...
        try {
            ...
            System.out.println();
            //getting the Iterator
            for (String instructor : instructors) {//check if iterator has the elements
                System.out.println(instructor);//printing the element and move to next
            }
            System.out.println();
            System.out.println("---------------------------------------");
            System.out.println();
    ...
    public void addGrade() {
        ...
        try {
            ...
            Student st = new Student();
            if(st.checkStudent(moduleID, studentID)) {
                if (check(studentID)) {
    ...
    public boolean check(int id){
        ...
        try{
            ...
            while(rs.next()){
                if(checkInstructor(Integer.parseInt(rs.getString(1)), getID())){
                    return true;
                }
            }
