...
public class Administrator {
    ...
    public boolean adminLogin(){
        ...
        if(isInDatabase(username)){
            if(validateAdmin(username,pass)){
                return true;
            }
            else{
                System.out.println();
    ...
    public void cancelCourse() {
        ...
        for (String s : courseList) {//check if iterator has the elements
            System.out.println(s);//printing the element and move to next
        }
    ...
    public void assignNewInstructor(){
         ...
         */
            if (mo.isInDatabase(moduleID)) {
                if (!ins.checkInstructor(moduleID, instructorID)) {
    ...
    public void assignInstructorToCourse(){
        ...
        try {
            ...
            if (ins.isInDatabase(instructorID)) {
                Module mo = new Module();
                if (mo.isInDatabase(moduleID)) {
                    if (!ins.checkInstructor(moduleID, instructorID)) {
                        ins.setModuleID(moduleID);
